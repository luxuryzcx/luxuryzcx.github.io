...
date = 2026-06-15T20:16:52+08:00
draft = false
description = "一些打过的靶机"
tags = ["靶机"]
categories = ["靶机"]
...
![image.png](https://luxury-1393333723.cos.ap-nanjing.myqcloud.com//img/20260227224220356.png)

访问web页面   没什么东西  是一个 cms

![image.png](https://luxury-1393333723.cos.ap-nanjing.myqcloud.com//img/20260227224308445.png)


```
gobuster dir -u http://61.139.2.144:66 -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -x .php,.txt,.html,.sh
```
![image.png](https://luxury-1393333723.cos.ap-nanjing.myqcloud.com//img/20260227232520662.png)



```
curl http://61.139.2.144:66/flag.txt
```

![image.png](https://luxury-1393333723.cos.ap-nanjing.myqcloud.com//img/20260227231906385.png)
...
![image.png](https://luxury-1393333723.cos.ap-nanjing.myqcloud.com//img/20260227233439496.png)
